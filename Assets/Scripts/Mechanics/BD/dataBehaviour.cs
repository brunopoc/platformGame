...
public class dataBehaviour : MonoBehaviour {
    ...
    Text btnText1; //texto do botão 1 (para ativa-lo)
    Text btnText2; //texto do botão 2 (para ativa-lo)
    Text btnText3; //texto do botão 3 (para ativa-lo)
    ...
    */
    ...
    void loadDate1 (){  //Lógica do loading APENAS para Botões
	    checkDate();
    ...
    void loadDate2 (){  //Lógica do loading APENAS para Botões
	    checkDate();
		    if(loadingOption == true){
	     levelsFinish = PlayerPrefs.GetInt("Níveis Concluidos 2");
	     crystalCollect = PlayerPrefs.GetInt("Cristais Coletados 2");
    ...
    void loadDate3 (){  //Lógica do loading APENAS para Botões
	    checkDate();
		    if(loadingOption == true){
	     levelsFinish = PlayerPrefs.GetInt("Níveis Concluidos 3");
	     crystalCollect = PlayerPrefs.GetInt("Cristais Coletados 3");
    ...
    void saveDate1 (){ //Lógica do Save APENAS para Botões
	    checkDate();
    ...
    void saveDate2 (){ //Lógica do Save APENAS para Botões
	    checkDate();
    ...
    void saveDate3 (){ //Lógica do Save APENAS para Botões
	    checkDate();
    ...
    void ConfirmSaveIn (){ //Botão de salvar do dialogo se quer sobrescrever o dado
    ...
    void CancelSaveIn (){ //Botão de cancelar do dialogo se quer sobrescrever o dado
